...
def mix_state_dict(state_dict_1, state_dict_2, alpha=0.5):
    from collections import OrderedDict
    mix_state_dict = OrderedDict()
    for k, v in state_dict_1.items():
        v_1 = v
        v_2 = state_dict_2[k]
        mix_v = alpha * v_1 + (1 - alpha) * v_2
        mix_state_dict[k] = mix_v
    return mix_state_dict
