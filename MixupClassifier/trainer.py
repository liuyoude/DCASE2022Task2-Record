    ...
    def train(self, train_loader, valid_dirs):
        ...
        for epoch in range(0, epochs+1):
            ...
            for (x_wavs, x_mels, labels, one_hots) in train_bar:
                ...
                labels, one_hots = labels.float().to(self.args.device), one_hots.float().to(self.args.device)
            ...
            # valid
            if epoch <= 20 or epoch % valid_every_epochs == 0:
        ...
        for index, target_dir in enumerate(sorted(valid_dirs)):
            ...
            for section_str in machine_section_list:
                ...
                for file_idx, file_path in enumerate(test_files):
                    ...
                    # probs = torch.sigmoid(out_classes).mean(dim=0).squeeze().cpu().numpy()
