...
def filename2attributes(filename):
    ...
    # attribute_list.append(section + '_' + domain)
...
if __name__ == '__main__':
    ...
    section_str = 'section_02'
    target_dir = f'../../data/dcase2022dataset/dev_data/{machine_type}/train'
    machine_section_file_atts, _ = get_file_attributes(target_dir, machine=machine_type, section=section_str)
    print(machine_section_file_atts, len(machine_section_file_atts))
    target_dir = f'../../data/dcase2022dataset/dev_data/{machine_type}/test'
    machine_section_file_atts, _ = get_file_attributes(target_dir, machine=machine_type, section=section_str)
    print(machine_section_file_atts, len(machine_section_file_atts))
