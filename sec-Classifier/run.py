...
def main(args):
    ...
    # TODO !important section classifier: map_file_section
    args.file_att_2_idx, args.idx_2_file_att = utils.map_file_section(args.root_dir)
    _, file_att_state = utils.get_file_sections(args.root_dir)
    ...
    trainer.valid(valid_dirs=args.valid_dirs, save=True)
...
def run():
    ...
    # args.version = f'STgram_MFN_FocalLoss_ArcFace(m={args.m},s={args.s},c={args.sub})'
    args.version = f'sec-STgram_MFN_CE'
    if args.arcface: args.version += f'_ArcFace(m={args.m},s={args.s},c={args.sub})'
    ...
    if args.test:
        args.version = f'2022-05-22-14-sec-STgram_MFN_CE_ArcFace(m=0.7,s=30,c=16)'
        log_dir = f'runs/{args.version}'
    # log_dir = 'runs/2022-04-01-22-STgram_MFN_FocalLoss'
